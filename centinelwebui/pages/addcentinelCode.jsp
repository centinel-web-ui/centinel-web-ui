...
<!-- JSP Code for inserting the Centinel Code in the database -->
<!-- We insert it into a table called as centinels -->

<%
  centinelcode = request.getParameter("Code");
...
// Register with Centinel Running Service
	/*try {
	String str = "curl -k -i -H \"Content-Type: application/json\" -X POST -d '{\"username\":\""+centinelcode+"\", \"password\":\"sbuuser\"}' https://0.0.0.0:8082/register";
	out.println(str);
	...
	*/
	...
	preparedStatement = c.prepareStatement("insert into centinelweb.centinels values (?,?,?)");
      preparedStatement.setString(1, sessionUserName);
      preparedStatement.setString(2, centinelcode);
      preparedStatement.setString(3, sessionUserCountry);
      ...
      %>
			...
			<div class="panel-body">
	                 <div class="alert alert-success">
                        Centinel with code <%=centinelcode %> added successfully.
	      	         </div>
                         </div>
		...
		<div class="row">
			<div class="panel-body">
	                 <div class="alert alert-danger">
                        There was error while adding Centinel with code <%=centinelcode %>. 
	      	         </div>
                         </div>
		</div>
<%
...
<!-- JSP Code Ends Here-->
		...
		<div class="row">
			...
			<!-- Code starts -->
			    <form id="newmain" name="newmain" class="form-horizontal" action="addcentinelCode.jsp" method="post" novalidate>
  ...
  <script>
    (function() {
      ...
      document.querySelector("form#newmain")
