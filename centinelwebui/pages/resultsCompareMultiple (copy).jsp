...
<head>
    ...
    <title>Internet Censorship Project- CSE 534</title>
...
%>
<%
	numFilesCount = Integer.parseInt(request.getParameter("numFiles"));
	for(int i=1;i<numFilesCount+1;i++){
		jsonfiles[i] = request.getParameter("jsonfile"+i);
	}

	for(int i=1;i<numFilesCount+1;i++){
		out.println(jsonfiles[i]);
	}
...
%>
            <div class="row">
                             ...
                             <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                                    <thead>
                                        <tr>
                                            <th>Host</th>
                                            <th>Success Ping 1</th>
                                            <th>Success Ping 2</th>
				...
				var dataTable = $('#dataTables-example2').DataTable();
						...
						for(i=0;i<arr[0].ping.length ;i++){
							...
							if(arr[0].ping[i].success=="true"){
								success1Array.push('<span class=text-success>true</span>');
							} else {
								success1Array.push('<span class=text-danger>false</span>');
							} 
							timetaken1 = arr[0].meta.time_taken;
				...
				var dataTable = $('#dataTables-example2').DataTable();
						...
						for(i=0;i<arr[0].ping.length ;i++){
							if(arr[0].ping[i].success=="true"){
								success2Array.push('<span class=text-success>true</span>');
							} else {
								success2Array.push('<span class=text-danger>false</span>');
							} 							

							timetaken2 = arr[0].meta.time_taken;
						...
						for(j=0;j<hostsArray.length;j++){
							...
							dataTable.row.add([hostsArray[j],success1Array[j],success2Array[j]]).draw();
						}
