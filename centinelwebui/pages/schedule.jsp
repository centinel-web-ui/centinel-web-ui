...
String centineltoschedule = request.getParameter("centineltoschedule");
String expttoschedule = request.getParameter("expttoschedule");

if(centineltoschedule != null){
%>
<script>
$(function() {
$("#cent").val('<%=centineltoschedule%>');
populateSelect();
$("#item").val('<%=expttoschedule%>');
});
</script>
<%
}
...
// Fetch centinel values and experiment values for the user
	String sqlQuery="select * from centinelweb.experiments where username=\""+sessionUserName.trim()+"\"";
	Statement statement=c.createStatement();

        ResultSet rst=statement.executeQuery(sqlQuery);
outputList.clear();
	while(rst.next()){
		outputList.add(rst.getString(7) + ","+rst.getString(3));
	}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Enter details of Experiment Schedule
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                
                                    <form role="form" action="scheduleDone.jsp">
		                	<div class="col-lg-3">                        
...
%>			
					...
					<div class="col-lg-3">                        
 					<div class="form-group">
                                            ...
                                            <select class="form-control" id="item" name="exptnode">

                                            </select>
                                            <p class="help-block">Experiment to be run</p>
                                        </div>
					</div>
		                	<div class="col-lg-3"> 
					<div class="form-group">
                                            <label>Run Interval</label>
                                            <input class="form-control" name="runnode">
		                	...
		                	<div class="col-lg-3"> 
                                        <div class="form-group">
                                           <br/>
                                            ...
                                            <p class="help-block">Schedule Experiment</p>
                                        </div>
                                        </div>
