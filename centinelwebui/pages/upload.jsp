...
%>
			...
			<!-- Code for file upload starts-->
					...
					<label>Select Centinel</label>
		                          <select class="form-control" id="centnode" name="centnode" onchange="submit();">
					...
					for(int i=0;i<outputList.size();i++){
						String centinel = outputList.get(i);

						if(hashS.add(centinel)){
							out.println( "<option value='" + centinel + "'>" + centinel+"</option>");
						}	
					}
					...
					<p class="help-block">Centinel on which experiment will be run</p>
