...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><span class="text-primary">Server Information</span></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-8">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Centinel Server Information
                        </div>
                        <div class="panel-body">
                            <div id="server"></div>
			    
			     <!-- Read values from a file and display here -->
                         </div>
			<script>

			function myFunction(arr) {
				var out = "";
				out += '<p><span class="text-primary">Server URL:            </span> ' + arr[0].server.server_url + '</p><p><span class="text-primary">SSL Certificate Verification:</span> ' + arr[0].server.verify + '</p>';
	
				document.getElementById("server").innerHTML = out;
			}
			</script>
